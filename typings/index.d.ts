declare module 'discord.js-commando' {
  ...
  export class CommandoClient extends Client {
    ...
    on(
      ...
      listener: (guild: CommandoGuild, prefix: string) => void,
    ): this;
    on(
      event: 'commandRegister',
      listener: (command: Command, registry: CommandoRegistry) => void,
    ): this;
    on(
    ...
    on(
      event: 'groupRegister',
      listener: (group: CommandGroup, registry: CommandoRegistry) => void,
    ): this;
    on(
    ...
    on(
      event: 'typeRegister',
      listener: (type: ArgumentType, registry: CommandoRegistry) => void,
    ): this;
    on(
      event: 'unknownCommand',
      listener: (message: CommandoMessage) => void,
    ): this;
    ...
    on(
      event: 'guildBanAdd',
      listener: (guild: CommandoGuild, user: User) => void,
    ): this;
    on(
    ...
    on(
      ...
      listener: (guild: CommandoGuild) => void,
    ): this;
    on(
      event: 'guildUpdate',
      listener: (oldGuild: CommandoGuild, newGuild: CommandoGuild) => void,
    ): this;
    ...
    on(
      event: 'providerReady',
      listener: (provider: SettingProvider) => void,
    ): this;
